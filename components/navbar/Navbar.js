...
const Navbar = ({ isMobile, isOpen, setIsOpen }) => {
    ...
    return (
        <>
            ...
            <div>
                <nav style={navbarStyle} className={`${isMobile ? 'fixed inset-0 flex-col bg-apex-green space-y-4 w-full text-white overflow-y-auto' : `mx-12 mb-8 mt-24 justify-between text-gray-600`} flex items-center`}>
